...
const Usuario = sequelize.define('Usuario', {
    ...
    rol: {
        type: DataTypes.ENUM('Cliente', 'Trabajador', 'Administrador', 'Veterinario', 'Recepcionista', 'Asistente Veterinario', 'Personal de Servicios', 'Encargado de Inventario', 'Superadmin'), // Define roles como ENUM
        allowNull: false,
    },
    sueldo: {
